...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tx = (TextView)findViewById(R.id.fadingTextView);
    ...
    protected void onStart() {
        ...
        if (mAuth.getCurrentUser() != null) {
            finish();
            startActivity(new Intent(this, TravenuActivity.class));
        }
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //startActivity(new Intent(HomeActivity.this, com.programunlocked.travenu.activities.MainActivity.class));

                            startActivity(new Intent(HomeActivity.this, TravenuActivity.class));
                            finish();
                        } else {
